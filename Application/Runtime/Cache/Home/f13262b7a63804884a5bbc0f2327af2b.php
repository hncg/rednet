        ...
        <div id="line_form">
        	<form>
	                ...
	                <select name="line_year" id="line_year" onchange="refresh_line()" autocomplete="off">
	        			<?php $__FOR_START_1818048015__=2013;$__FOR_END_1818048015__=2018;for($temp=$__FOR_START_1818048015__;$temp < $__FOR_END_1818048015__;$temp+=1){ ?><option <?php if(($temp) == $dateNow->year): ?>selected="selected"<?php endif; ?> value="<?php echo ($temp); ?>"><?php echo ($temp); ?>年</option><?php } ?>
	        		</select>
	        		<select name="line_month" id="line_month" onchange="refresh_line()" autocomplete="off">
	        			<?php $__FOR_START_330391693__=1;$__FOR_END_330391693__=13;for($temp=$__FOR_START_330391693__;$temp < $__FOR_END_330391693__;$temp+=1){ ?><option value="<?php echo ($temp); ?>" <?php if(($temp) == $dateNow->month): ?>selected="selected"<?php endif; ?> ><?php if(($temp) < "10"): ?>0<?php endif; echo ($temp); ?> 月</option><?php } ?>
	        		</select>
        	</form>
        </div>
	</div>
